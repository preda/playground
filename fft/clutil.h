 ...
 private:
  ...
  void init(Context &c, FILE *f, bool isBinary, bool isCL2) {
    ...
    const char *opts = isCL2 ?
      "-O3 -Werror -cl-std=CL2.0 -cl-uniform-work-group-size -I. -fno-bin-llvmir -save-temps=tmp2/" :
      "-O3 -Werror -cl-fast-relaxed-math -I. -fno-bin-llvmir -fno-bin-source -fno-bin-amdil -save-temps=tmp1/";
    /*
    const char *opts = isCL2
